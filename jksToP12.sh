...
keytool -importkeystore -srckeystore `hostname`.jks -srcstorepass abc123 -destkeystore bluemix-app.p12 -deststoretype PKCS12 -srcalias `hostname` -deststorepass abc123 -destalias `hostname`-signed
